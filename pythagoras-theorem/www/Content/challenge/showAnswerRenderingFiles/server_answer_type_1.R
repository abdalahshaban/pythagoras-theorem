...
output[["plot_Ch_one_image_one"]] <- renderPlot({
  ...
  text(A, x = 91, y = 97, cex = cex, col = color, font = 7)
  text(B, x = 91, y = 7, cex = cex, col = color, font = 7)
  text(C, x = 8, y = 7, cex = cex, col = color, font = 7)
  text(D, x = 50, y = 7, cex = cex, col = color, font = 7)
