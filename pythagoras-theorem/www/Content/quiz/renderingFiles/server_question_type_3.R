...
output[["plot_quiz_eight_image_one"]] <- renderPlot({
  ...
  text(B, x = 95, y = 56, cex = cex, col = color, font = 7)
  text(C, x = 50, y = 57, cex = cex, col = color, font = 7)
  text(D, x = 5, y = 44, cex = cex, col = color, font = 7)
  text(E, x = 5, y = 101, cex = cex, col = color, font = 7)
  text(paste(con_num(AB_num), cm), x = 101, y = 25, cex = cex, col = color, font = 7, srt = -90)
  text(paste(con_num(BC_num), cm), x = 75, y = 56, cex = cex, col = color, font = 7)
